...
import EmployeeApplicationContainer from "../views/applications/EmployeeApplicationContainer";
import EmployeeApplicationViewContainer from "../views/applications/EmployeeApplicationViewContainer";
import EmployeeApplicationListContainer from "../views/applications/EmployeeApplicationListContainer";
import EmployeeCrReportViewContainer from "../views/employee/EmployeeCrReportViewContainer";
import EmployeeApplicationEditContainer from "../views/applications/EmployeeApplicationEditContainer";
import CertificateDayRerportContainer from "../../../domains/Report/views/report/CertificateDayRerportContainer";
import FCBEFTNReportContainer from "../../../domains/Report/views/report/FCBEFTNReportContainer";
import ReportVoyageContainer from "../../../domains/Report/views/report/ReportVoyageContainer";
import SalaryGenerateContainer from "../../../domains/Report/views/report/SalaryGenerateContainer";
import SalaryReportCheckContainer from "../../../domains/Report/views/report/SalaryReportCheckContainer";
import SalaryReportContainer from "../../../domains/Report/views/report/BEFTNReportContainer";
...
const routesCCO = [
  ...
  {
    path: "/employee/cr-report-view",
    name: "Hr",
    component: EmployeeCrReportViewContainer,
    exact: true,
  },
  {
  ...
  {
    path: "/employee/employee-application-list",
    name: "Application",
    component: EmployeeApplicationListContainer,
    exact: true,
  },

  {
    path: "/employee/employee-application/show",
    name: "Application",
    component: EmployeeApplicationViewContainer,
    exact: true,
  },
  {
    path: "/employee/employee-application/add",
    name: "Application",
    component: EmployeeApplicationContainer,
    exact: true,
  },
  {
    path: "/employee/employee-application/edit",
    name: "Application",
    component: EmployeeApplicationEditContainer,
    exact: true,
  },
];
