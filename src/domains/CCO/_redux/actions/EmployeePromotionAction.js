...
export const GetEmployeePromotionList = (intEmployeeId) => async (dispatch) => {
  ...
  if (typeof intEmployeeId != "undefined") {
    axios
      .get(
        `http://iapps.akij.net/asll/public/api/v1/asllhr/promotion/getEmployeePromotionList?intEmployeeId=${intEmployeeId}`,
        {
          headers: headers,
        }
      )
...
export const GetEmployeeRankList = () => async (dispatch) => {
  ...
  axios
    .get(`http://iapps.akij.net/asll/public/api/v1/asllhr/getRanksPrint`, {
      headers: headers,
    })
    .then((res) => {
      let data = res.data;
...
export const DeleteEmployeePromotion = (intID) => async (dispatch) => {
  ...
  axios
    .delete(
      `http://iapps.akij.net/asll/public/api/v1/asllhr/promotion/deleteEmployeePromotion?intID=` + intID,
      { headers: headers }
    )
    .then((res) => {
