...
import { GetVesselList, DeleteVessel, VesselEmptyDeleteMessage } from "../../_redux/actions/VesselAction";
...
const VesselList = withRouter(({ history, props }) => {
  ...
  return (
          ...
          <div className="card-body">
            ...
            <div className="react-bootstrap-table table-responsive">
              <table className="table table table-head-custom table-vertical-center">
                ...
                <tbody>
                  {vesselList && vesselList.map((item, index) => (
                    <tr key={index}>
                      <td>{index + 1}</td>
                      ...
                      <td>
                        <a className="btn btn-icon btn-light btn-hover-info btn-sm" onClick={() => {
    ...
    <a className="btn btn-icon btn-light btn-hover-danger btn-sm" onClick={() => { if (window.confirm('Are you sure you wish to delete this item?')) vesselDelete(item.intID) }}>
