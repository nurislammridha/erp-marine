...
export function DashboardMain() {
  ...
  let employeeInfoList = useSelector(
  ...
  return (
    <div className="container mt-4">
      <div className="row mt-5">
              ...
              >
                <div className="px-6 py-8 rounded-xl mb-7 shipping-card">
                  <span className="svg-icon svg-icon-3x svg-icon-primary d-block my-2">
                    <img src={toAbsoluteUrl("/media/dashboard/ship.png")} />
                  </span>
                  <h2>
                    {vesselList != "undefined" && vesselList != null
                      ? vesselList.length
                      : 0}{" "}
                  </h2>
                  <p>Total Vessel e</p>
            ...
            <div className="dashboard-card">
              ...
              >
                <div className="px-6 py-8 rounded-xl mb-7 shipping-card second-color">
                  <span className="svg-icon svg-icon-3x svg-icon-primary d-block my-2">
                    <img src={toAbsoluteUrl("/media/dashboard/user.png")} />
                  </span>
                  <h2>
                    {" "}
                    {employeeInfoList != "undefined" && employeeInfoList != null
                      ? employeeInfoList.length
                      : 0}{" "}
                  </h2>
                  <p>Total Employee </p>
                </div>
        ...
        {typeof intVesselId !== undefined &&
          intVesselId !== null &&
          intVesselId !== "" && (
            <PermissionWiseDisplay
              permission_name={"profile_update"}
              display={false}
            >
              <div className="col-lg-3 col-xxl-4">
                <div className="dashboard-card">
